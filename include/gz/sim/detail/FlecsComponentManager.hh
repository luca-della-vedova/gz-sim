 ...
 *
*/
#ifndef GZ_SIM_DETAIL_FLECSCOMPONENTMANAGER_HH_
#define GZ_SIM_DETAIL_FLECSCOMPONENTMANAGER_HH_
...
//////////////////////////////////////////////////
template<typename ComponentTypeT>
ComponentTypeT *FlecsComponentManager::ComponentDefault(Entity _entity,
...
std::optional<typename ComponentTypeT::Type>
    FlecsComponentManager::ComponentData(const Entity _entity) const
{
  auto comp = this->Component<ComponentTypeT>(_entity);
  if (!comp)
    return std::nullopt;
...
//////////////////////////////////////////////////
template<typename ComponentTypeT>
bool FlecsComponentManager::SetComponentData(const Entity _entity,
...
//////////////////////////////////////////////////
template<typename ...ComponentTypeTs>
std::vector<Entity> FlecsComponentManager::EntitiesByComponents(
    const ComponentTypeTs &..._desiredComponents) const
{
  // Get all entities which have components of the desired types
  const auto &view = this->FindView<ComponentTypeTs...>();
...
//////////////////////////////////////////////////
template<typename ...ComponentTypeTs>
std::vector<Entity> FlecsComponentManager::ChildrenByComponents(Entity _parent,
     const ComponentTypeTs &..._desiredComponents) const
{
  // Get all entities which have components of the desired types
  const auto &view = this->FindView<ComponentTypeTs...>();
...
//////////////////////////////////////////////////
template<typename ...ComponentTypeTs>
void FlecsComponentManager::EachNoCache(typename identity<std::function<
...
//////////////////////////////////////////////////
template <typename... ComponentTypeTs>
void FlecsComponentManager::EachNew(typename identity<std::function<
    bool(const Entity &_entity, ComponentTypeTs *...)>>::type _f)
{
...
//////////////////////////////////////////////////
template<typename ...ComponentTypeTs>
void FlecsComponentManager::EachRemoved(typename identity<std::function<
    bool(const Entity &_entity, const ComponentTypeTs *...)>>::type _f) const
{
  // Get the view. This will create a new view if one does not already
  // exist.
...
//////////////////////////////////////////////////
template<typename ...ComponentTypeTs>
detail::View *FlecsComponentManager::FindView() const
{
  ...
  if (nullptr != baseViewPtr)
  {
    ...
    for (const auto &[entity, isNew] : view->ToAddEntities())
    {
      ...
      view->AddEntityWithComps(entity, isNew,
          const_cast<FlecsComponentManager*>(this)->Component<ComponentTypeTs>(
            entity)...);
    }
