...
namespace gz
{
  namespace sim
  {
    ...
    **/
    /// \brief The FlecsComponentManager constructs, deletes, and returns
    /// components and entities.
    /// A component can be of any class which inherits from
    /// `components::BaseComponent`.
    class GZ_SIM_VISIBLE FlecsComponentManager
    {
      /// \brief Constructor
...
#include "gz/sim/detail/FlecsComponentManager.hh"
