...
class gz::sim::FlecsComponentManagerPrivate
{
  ...
  /// False otherwise
  /// \note This method should only be called in FlecsComponentManager::Clone.
  ...
  : dataPtr(new FlecsComponentManagerPrivate)
{
  ...
  world.component<SimEntity>();
  world.component<NewEntity>();
  world.component<RemoveEntity>();
...
{
  auto e = this->world.entity().add<SimEntity>().add<NewEntity>().id() - this->dataPtr->entityOffset;
  return e;
}
...
/////////////////////////////////////////////////
Entity FlecsComponentManager::CloneImpl(Entity _entity, Entity _parent,
    const std::string &_name, bool _allowRename)
{
...
/////////////////////////////////////////////////
bool FlecsComponentManager::HasRemovedComponents() const
{
...
/*
/////////////////////////////////////////////////
void FlecsComponentManager::ClearRemovedComponents()
{
  std::lock_guard<std::mutex> lock(this->dataPtr->removedComponentsMutex);
...
/////////////////////////////////////////////////
void FlecsComponentManager::ProcessRemoveEntityRequests()
{
  GZ_PROFILE("FlecsComponentManager::ProcessRemoveEntityRequests");
  std::lock_guard<std::mutex> lock(this->dataPtr->entityRemoveMutex);
    ...
    const Entity _entity, const ComponentTypeId &_typeId)
{
  ...
  {
    oneTimeIter->second.erase(entity);
  ...
  {
    periodicIter->second.erase(entity);
    if (periodicIter->second.empty())
      this->dataPtr->periodicChangedComponents.erase(periodicIter);
  }

  auto compPtr = this->ComponentImplementation(entity, _typeId);
  if (compPtr)
  {
    this->dataPtr->componentsMarkedAsRemoved[entity].insert(_typeId);

    // update views to reflect the component removal
    for (auto &viewPair : this->dataPtr->views)
      viewPair.second.first->NotifyComponentRemoval(entity, _typeId);
  }
  ...
  */
  ...
  {
    std::lock_guard<std::mutex> lock(this->dataPtr->removedComponentsMutex);
    this->dataPtr->removedComponents[entity].insert(_typeId);
  }
...
/////////////////////////////////////////////////
bool FlecsComponentManager::IsMarkedForRemoval(const Entity _entity) const
{
  std::lock_guard<std::mutex> lock(this->dataPtr->entityRemoveMutex);
...
/////////////////////////////////////////////////
bool FlecsComponentManager::HasPeriodicComponentChanges() const
{
...
std::unordered_set<ComponentTypeId>
    FlecsComponentManager::ComponentTypesWithPeriodicChanges() const
{
...
/////////////////////////////////////////////////
void FlecsComponentManager::UpdatePeriodicChangeCache(
...
/////////////////////////////////////////////////
Entity FlecsComponentManager::ParentEntity(const Entity _entity) const
{
...
/////////////////////////////////////////////////
bool FlecsComponentManager::SetParentEntity(const Entity _child,
...
/////////////////////////////////////////////////
bool FlecsComponentManager::CreateComponentImplementation(
...
/////////////////////////////////////////////////
bool FlecsComponentManager::EntityMatches(Entity _entity,
...
const components::BaseComponent
    *FlecsComponentManager::ComponentImplementation(
    const Entity _entity, const ComponentTypeId _type) const
{
  GZ_PROFILE("FlecsComponentManager::ComponentImplementation");
...
/////////////////////////////////////////////////
components::BaseComponent *FlecsComponentManager::ComponentImplementation(
    const Entity _entity, const ComponentTypeId _type)
{
  // Call the const version of the function
  return const_cast<components::BaseComponent *>(
      static_cast<const FlecsComponentManager &>(
...
//////////////////////////////////////////////////
const EntityGraph &FlecsComponentManager::Entities() const
{
  return this->dataPtr->entities;
}

//////////////////////////////////////////////////
std::pair<detail::BaseView *, std::mutex *> FlecsComponentManager::FindView(
...
//////////////////////////////////////////////////
detail::BaseView *FlecsComponentManager::AddView(
...
//////////////////////////////////////////////////
void FlecsComponentManager::RebuildViews()
{
  GZ_PROFILE("FlecsComponentManager::RebuildViews");
  for (auto &viewPair : this->dataPtr->views)
  {
...
//////////////////////////////////////////////////
void FlecsComponentManager::AddEntityToMessage(msgs::SerializedStateMap &_msg,
...
//////////////////////////////////////////////////
msgs::SerializedState FlecsComponentManager::ChangedState() const
{
...
/*
//////////////////////////////////////////////////
void FlecsComponentManager::ChangedState(
...
//////////////////////////////////////////////////
void FlecsComponentManagerPrivate::CalculateStateThreadLoad()
{
...
//////////////////////////////////////////////////
void FlecsComponentManager::PeriodicStateFromCache(
  msgs::SerializedStateMap &_state,
...
{
  GZ_PROFILE("FlecsComponentManager::SetState Non-map");
...
//////////////////////////////////////////////////
void FlecsComponentManager::SetAllComponentsUnchanged()
{
...
/////////////////////////////////////////////////
void FlecsComponentManager::LockAddingEntitiesToViews(bool _lock)
{
  this->dataPtr->lockAddEntitiesToViews = _lock;
}

/////////////////////////////////////////////////
bool FlecsComponentManager::LockAddingEntitiesToViews() const
{
  return this->dataPtr->lockAddEntitiesToViews;
}

/////////////////////////////////////////////////
void FlecsComponentManagerPrivate::AddModifiedComponent(const Entity &_entity)
{
...
*/
/////////////////////////////////////////////////
bool FlecsComponentManagerPrivate::ComponentMarkedAsRemoved(
...
bool FlecsComponentManagerPrivate::ClonedJointLinkName(Entity _joint,
    Entity _originalLink, FlecsComponentManager *_ecm)
{
...
/////////////////////////////////////////////////
EntityComponentManagerDiff FlecsComponentManager::ComputeEntityDiff(
...
/////////////////////////////////////////////////
void FlecsComponentManager::ApplyEntityDiff(
    const FlecsComponentManager &_other,
...
/////////////////////////////////////////////////
void FlecsComponentManager::ResetTo(const FlecsComponentManager &_other)
{
  auto ecmDiff = this->ComputeEntityDiff(_other);
  FlecsComponentManager tmpCopy;
