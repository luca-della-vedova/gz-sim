...
class FlecsCompMgrTest : public FlecsComponentManager
{
  ...
  public: void RunApplyDiff(const FlecsComponentManager &_other,
...
/////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, InvalidComponentType)
{
...
//////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, RemoveEntity)
{
  // Create some entities
...
/////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, GZ_UTILS_TEST_DISABLED_ON_WIN32(State))
{
...
/////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, Descendants)
{
  // - 1
  //   - 2
  //   - 3
...
static void CompareEntityComponents(const FlecsComponentManager &_ecm,
...
//////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, PinnedEntity)
{
  // Create some entities
  auto e1 = manager.CreateEntity();
  EXPECT_EQ(1u, e1);
       ...
       GZ_UTILS_TEST_DISABLED_ON_WIN32(StateMsgUpdateComponent))
{
  ...
  FlecsComponentManager originalECMStateMap;
  FlecsComponentManager otherECMStateMap;
  ...
  FlecsComponentManager originalECMState;
  FlecsComponentManager otherECMState;
...
//////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, ResetToWithDeletedEntity)
{
  Entity entity1 = manager.CreateEntity();
  math::Pose3d testPose{1, 2, 3, 0.1, 0.2, 0.3};
  manager.CreateComponent(entity1, components::Pose{testPose});
...
//////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, ResetToWithAddedEntity)
{
  Entity entity1 = manager.CreateEntity();
  math::Pose3d testPose{1, 2, 3, 0.1, 0.2, 0.3};
...
//////////////////////////////////////////////////
TEST_P(FlecsComponentManagerFixture, EntityByName)
{
...
// problems.
INSTANTIATE_TEST_SUITE_P(FlecsComponentManagerRepeat,
    FlecsComponentManagerFixture, ::testing::Range(1, 10));
